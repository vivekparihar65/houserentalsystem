...
public class room extends AppCompatActivity {
    ...
    //for posting add
        btnpstad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(room.this, "Uploaded  room details succesfully!!", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(room.this,dashboard.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.about)
        {
            AlertDialog about=new AlertDialog.Builder(room.this).setTitle("About Developer").
